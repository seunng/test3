...
<body>
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/uri/test:eatspot" >
          ...
          <li class="dropdown nav-item">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
             ...
             <ul class="dropdown-menu dropdown-with-icons">
                ...
                <i class="fa fa-twitter"></i> All Components</a>
                            <li>
       ...
       <!-- <li class="nav-item">
          ...
          <li class="nav-item">
           ...
           <li>
          <a href="http://localhost/uri/test:login" class="btn btn-primary btn-round">login</a>
            </li>
             <li>
          <a href="http://localhost/uri/test:signup" class="btn btn-primary btn-round">sign up</a>
            </li>
        </ul>
      </div>
    </div>
  ...
  <div class="header header-filter clear-filter purple-filter" data-parallax="true" style="background-image: url('');">
    <div class="container">
      <div class="row">
          <div class="brand">
            <h1>Tour Spot</h1>
